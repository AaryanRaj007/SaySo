...
function App() {
  ...
  // The technical error detail is logged to sayso.log on the Rust side
  ...
  // The payload is the backend error message (also logged to sayso.log).
  useEffect(() => {
  ...
  // onboarding (e.g. a model download failing because blob.sayso.computer is
