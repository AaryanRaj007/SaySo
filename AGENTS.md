...
- **Opening an issue:** Read [`.github/ISSUE_TEMPLATE/`](.github/ISSUE_TEMPLATE/). Blank issues are disabled; pick the right template (`bug_report.md` for bugs). Feature requests do not belong in issues — they go to [Discussions](https://github.com/AaryanRaj007/SaySo/discussions) (see `.github/ISSUE_TEMPLATE/config.yml`).
- **Proposing a feature:** SaySo is under a feature freeze. New features require community support gathered in [Discussions](https://github.com/AaryanRaj007/SaySo/discussions) before any PR is opened — see the PR template's "Community Feedback" section.
